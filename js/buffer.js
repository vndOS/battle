...
ani_canvas_el2.setAttribute("style", "box-shadow:0 0 40px 30px DarkCyan;cursor:none;display:none;position:absolute;z-index:3;");
...
ani_canvas_el3.setAttribute("style", "box-shadow:0 0 40px 30px DarkCyan;cursor:none;display:none;position:absolute;z-index:2;");
...
let ani_canvas_el4 = document.createElement('canvas');
ani_canvas_el4.setAttribute("wdith", "250px");
ani_canvas_el4.setAttribute("height", "250px");
ani_canvas_el4.setAttribute("style", "box-shadow:0 0 40px 30px DarkCyan;cursor:none;display:none;position:absolute;z-index:2;");
ani_canvas_el4.setAttribute("id", "ani_canvas4");

monitor.appendChild(ani_canvas_el4);


const ani_canvas4 = document.getElementById("ani_canvas4");
